...
def submit(request, course_id):
    ...
    # Crear un objeto de Submission asociado a la inscripción
    submission = Submission.objects.create(enrollment=enrollment)

    # Obtener las respuestas seleccionadas del formulario de examen
    selected_choices = extract_answers(request)

    # Agregar cada objeto de Choice seleccionado al objeto de Submission
    for choice_id in selected_choices:
        choice = Choice.objects.get(pk=choice_id)
        submission.choices.add(choice)

        # Guardar la instancia de Submission
        submission.save()

    # Redireccionar a la vista de resultados del examen con el ID de la inscripción
